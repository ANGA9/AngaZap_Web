        ...
        <section className="hero-section" style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
          ...
          <div className="container relative z-10" style={{ color: "white" }}>
            ...
            <p className="animate-fade-in-up" style={{ fontSize: "1.125rem", maxWidth: "600px", opacity: 0.9, animationDelay: "0.1s" }}>
              Programs designed to uplift communities and drive positive social impact.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              ...
              <h2 className="font-display" style={{ fontSize: "36px" }}>Investing in people</h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "60px" }}>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Education Grants</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Providing scholarships and educational support for the children of our top-performing driver partners.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--color-indigo-tint)", color: "var(--color-indigo)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "16px", marginBottom: "20px" }}>🏥</div>
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Health Camps</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Free annual medical checkups, eye exams, and subsidized healthcare plans for active drivers.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--color-indigo-tint)", color: "var(--color-indigo)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "16px", marginBottom: "20px" }}>👩🏽</div>
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Women Behind the Wheel</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>A dedicated onboarding and support program to empower more female entrepreneurs in the gig economy.</p>
              </div>
            </div>
