        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              ...
              <h2 className="font-display" style={{ fontSize: "36px" }}>Find what you need</h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "60px" }}>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Browse Topics</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Explore categories like Payments, Account Security, Ride Policies, and Delivery Tracking.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Search the Center</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Use the search bar in the app to instantly find articles matching your specific query.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--color-indigo-tint)", color: "var(--color-indigo)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "16px", marginBottom: "20px" }}>✉️</div>
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Contact Agent</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Can't find the answer? Start a live chat with our support team directly from any help article.</p>
              </div>
            </div>
