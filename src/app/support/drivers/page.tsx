...
export default function DriversSupportPage() {
  return (
    <>
      <Navbar />
      <main>
        ...
        <section className="hero-section" style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
          ...
          <div className="container relative z-10" style={{ color: "white" }}>
            ...
            <p className="animate-fade-in-up" style={{ fontSize: "1.125rem", maxWidth: "600px", opacity: 0.9, animationDelay: "0.1s" }}>
              Resources and assistance for the people who keep us moving.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              <span className="split-eyebrow" style={{ color: "var(--color-indigo)", fontWeight: 700, textTransform: "uppercase", fontSize: "0.875rem", letterSpacing: "0.05em", display: "block", marginBottom: "16px" }}>Partner Hub</span>
              <h2 className="font-display" style={{ fontSize: "36px" }}>We've got your back</h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "60px" }}>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Earnings & Payouts</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Check your daily summaries, resolve payout issues, and understand your incentives.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--color-indigo-tint)", color: "var(--color-indigo)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "16px", marginBottom: "20px" }}>📄</div>
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Document Updates</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Upload new licenses, insurance papers, or vehicle registration documents securely.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Safety Incidents</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Report a collision, aggressive passengers, or general safety concerns immediately.</p>
              </div>
            </div>
            ...
            <div style={{ position: "relative", width: "100%", height: "400px", margin: "0 auto", backgroundColor: "#f9fafb", borderRadius: "var(--radius-lg)", overflow: "hidden", border: "1px solid var(--admin-border)" }}>
              <Image 
                ...
                alt="Driver support illustration"
                fill
