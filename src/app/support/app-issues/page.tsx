        ...
        <section className="hero-section" style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
          ...
          <div className="container relative z-10" style={{ color: "white" }}>
            ...
            <p className="animate-fade-in-up" style={{ fontSize: "1.125rem", maxWidth: "600px", opacity: 0.9, animationDelay: "0.1s" }}>
              Troubleshooting for common app glitches and technical difficulties.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              <span className="split-eyebrow" style={{ color: "var(--color-indigo)", fontWeight: 700, textTransform: "uppercase", fontSize: "0.875rem", letterSpacing: "0.05em", display: "block", marginBottom: "16px" }}>Tech Support</span>
              <h2 className="font-display" style={{ fontSize: "36px" }}>Get back online</h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "60px" }}>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>App Crashing</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Steps to resolve frequent crashes, including clearing cache, updating the app, or reinstalling.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--color-indigo-tint)", color: "var(--color-indigo)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "16px", marginBottom: "20px" }}>📍</div>
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Location Inaccuracy</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Fix GPS dropouts and inaccurate pickup points by adjusting your device's location permissions.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--color-indigo-tint)", color: "var(--color-indigo)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "16px", marginBottom: "20px" }}>🔐</div>
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Login Problems</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Troubleshoot OTP failures, forgotten passwords, or accounts that have been temporarily locked.</p>
              </div>
            </div>
