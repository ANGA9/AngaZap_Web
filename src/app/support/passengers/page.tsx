...
export default function PassengersSupportPage() {
  return (
    <>
      <Navbar />
      <main>
        ...
        <section className="hero-section" style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
          ...
          <div className="container relative z-10" style={{ color: "white" }}>
            ...
            <p className="animate-fade-in-up" style={{ fontSize: "1.125rem", maxWidth: "600px", opacity: 0.9, animationDelay: "0.1s" }}>
              Get help with your rides, account, and payments.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              <span className="split-eyebrow" style={{ color: "var(--color-indigo)", fontWeight: 700, textTransform: "uppercase", fontSize: "0.875rem", letterSpacing: "0.05em", display: "block", marginBottom: "16px" }}>Help Center</span>
              <h2 className="font-display" style={{ fontSize: "36px" }}>How can we help?</h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "60px" }}>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Trip Issues</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Report a problem with a recent ride, driver behavior, or lost items.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--color-indigo-tint)", color: "var(--color-indigo)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "16px", marginBottom: "20px" }}>💳</div>
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Payment & Fares</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Understand your charges, request refunds, or update your payment methods.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--color-indigo-tint)", color: "var(--color-indigo)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "16px", marginBottom: "20px" }}>👤</div>
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Account Settings</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Manage your profile, change passwords, and update notification preferences.</p>
              </div>
            </div>
