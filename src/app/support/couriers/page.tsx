...
export default function CouriersSupportPage() {
  return (
    <>
      <Navbar />
      <main>
        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              <span className="split-eyebrow" style={{ color: "var(--color-indigo)", fontWeight: 700, textTransform: "uppercase", fontSize: "0.875rem", letterSpacing: "0.05em", display: "block", marginBottom: "16px" }}>Delivery Hub</span>
              <h2 className="font-display" style={{ fontSize: "36px" }}>Keep the goods moving</h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "60px" }}>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Package Issues</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>What to do if a package is damaged, undeliverable, or the recipient is unresponsive.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                <div style={{ width: "40px", height: "40px", borderRadius: "50%", backgroundColor: "var(--color-indigo-tint)", color: "var(--color-indigo)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "16px", marginBottom: "20px" }}>🏢</div>
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Fleet Management</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Tools for managing multiple vehicles, onboarding new drivers, and reviewing fleet earnings.</p>
              </div>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Weight & Compliance</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Guidelines on maximum weight limits, restricted items, and local transportation laws.</p>
              </div>
            </div>
            ...
            <div style={{ position: "relative", width: "100%", height: "400px", margin: "0 auto", backgroundColor: "#f9fafb", borderRadius: "var(--radius-lg)", overflow: "hidden", border: "1px solid var(--admin-border)" }}>
              <Image 
                ...
                alt="Courier support illustration"
                fill
