        ...
        <section className="hero-section" style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center", position: "relative" }}>
          ...
          <div className="container relative z-10" style={{ color: "white" }}>
            ...
            <p className="animate-fade-in-up" style={{ fontSize: "1.125rem", maxWidth: "600px", opacity: 0.9, animationDelay: "0.1s" }}>
              Real-time GPS tracking for rides, deliveries, and fleet management.
            </p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container">
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              <span className="split-eyebrow" style={{ color: "var(--color-indigo)", fontWeight: 700, textTransform: "uppercase", fontSize: "0.875rem", letterSpacing: "0.05em", display: "block", marginBottom: "16px" }}>Technology</span>
              <h2 className="font-display" style={{ fontSize: "36px" }}>Always know where you stand</h2>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "24px", marginBottom: "60px" }}>
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Precision Routing</h4>
              ...
              <div style={{ background: "white", padding: "32px", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-card)", border: "1px solid var(--admin-border)" }}>
                ...
                <h4 className="font-display" style={{ fontSize: "20px", marginBottom: "8px" }}>Accurate ETAs</h4>
                <p className="text-muted" style={{ fontSize: "15px", lineHeight: "1.6" }}>Our machine learning models constantly update estimated times of arrival based on traffic conditions.</p>
              </div>
            </div>
